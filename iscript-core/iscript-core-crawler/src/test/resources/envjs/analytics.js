...
(function() {
    ...
    var O = f, M = document, xa = function(a) {
        ...
        for (var a = O[oa], a = a.appName + a.version + a.platform + a.userAgent + (M[r] ? M[r] : "") + (M.referrer ? M.referrer : ""), b = a[y], c = O.history[y]; 0 < c; )
            a += c-- ^ b++;
        return La(a)
    };
    var oc = function() {
    ...
    var ad, bd = function(a, b, c) {
        if (!ad) {
            ...
            if (e = (d = (d = d && d[m](g) || e && e[m](g)) ? d[1] : ya("GASO")[0] || "") && d[m](/^(?:!([-0-9a-z.]{1,40})!)?([-.\w]{10,1200})$/i))
                zc("GASO", "" + d, c, b, a, 0), f._udo || (f._udo = b), f._utcp || (f._utcp = c), a = e[1], vc("https://www.google.com/analytics/web/inpage/pub/inpage.js?" + (a ? "prefix=" + a + "&" : "") + hd(), "_gasojs");
            ad = !0
        }
    };
    var pc = function(a) {
        ...
        c(Wb, Pa);
        c(Xb, Sa);
        ilog('this.b:'+JSON.stringify(this.b));
        Jc(this.b, a[Q]);
        Kc(this.b);
        this.b.set(jb, $c());
        ...
        if ("cookie" == P(a, ac)) {
            ...
            ilog('a:'+JSON.stringify(a));
            ilog('W:'+W);
            ilog('P(a, W):'+P(a, 'cookieDomain'));
            c || (c = P(a, W), d = P(a, $b) || 
        ...
        if (d && a.get(cc) && (b = M[B][h])) {
            ...
            d = [];
            for (c = 0; c < b[y]; ++c)
                (ea(b[c], "utm_id") || ea(b[c], "utm_campaign") || ea(b[c], "utm_source") || ea(b[c], "utm_medium") || ea(b[c], "utm_term") || ea(b[c], "utm_content") || ea(b[c], "gclid") || ea(b[c], "dclid") || ea(b[c], 
                "gclsrc")) && d[p](b[c]);
    ...
    var rc = function(a) {
    	ilog('M.visibilityState:'+M.visibilityState);
