...
//			if (javaObject instanceof Document || javaObject instanceof WindowAdapt) {
//				if (!ScriptableObject.hasProperty(start, name) && !ScriptableObject.hasProperty(parent, name)) {
