...
document.referrer="http://www.fanduoshao.com/job/";
location.href="http://www.fanduoshao.com/";
...
(function() {
    ...
    oa.prototype = {getData: function(a) {
            try {
    ...
    function sa() {
        var a = "Hm_cv_" + c.id;
        try {
            if (aa(a, "", {domain: qa(),path: ra(),f: -1}), window.sessionStorage && window.sessionStorage.removeItem(a), window.localStorage)
