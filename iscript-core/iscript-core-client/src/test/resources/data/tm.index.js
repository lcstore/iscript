!function() {
    function r() {
        ...
        for (var e = 0; 18 > e; e += 2)
            this.encipher(), this.bf_P[e] = this.xl_par, this.bf_P[e + 1] = this.xr_par;
        for (t = 0; 256 > t; t += 2)
            this.encipher(), this.bf_S0[t] = this.xl_par, this.bf_S0[t + 1] = this.xr_par;
        for (t = 0; 256 > t; t += 2)
            this.encipher(), this.bf_S1[t] = this.xl_par, this.bf_S1[t + 1] = this.xr_par;
        for (t = 0; 256 > t; t += 2)
            this.encipher(), this.bf_S2[t] = this.xl_par, this.bf_S2[t + 1] = this.xr_par;
        for (t = 0; 256 > t; t += 2)
            this.encipher(), this.bf_S3[t] = this.xl_par, this.bf_S3[t + 1] = this.xr_par;
    ...
    r.prototype.Fbf_P = function() {
        ...
        for (var t = 0; t < r.length % 8; t++)
            r += "0";
        for (var e = "", t = 0; t < r.length; t += 8) {
            var o = r.substr(t, 4), n = r.substr(t + 4, 4), i = o.charCodeAt(3) | o.charCodeAt(2) << 8 | o.charCodeAt(1) << 16 | o.charCodeAt(0) << 24;
            0 > i && (i = 4294967296 + i);
    ...
    var e = {decode: function(r) {
        ...
        function o(r) {
            for (var t, e = "", o = 0; r > o; o++)
                t = Math.floor(10 * Math.random()), 0 == o && "0" == t && (t = 1), e += t;
            return e
        }
        function n(r) {
            return 10 > r ? "0" + r : r
        ...
        return function() {
            ...
            function h() {
                ...
                var s = {name: w,version: x,core: _,os: c,cls: h[0] + "" + h[1] + h[2] + r,num: h,canCheckOS: u,canCheckBrowser: e};
                return s
            }
            var s, c, d, f = navigator.userAgent, u = ["windows", "mac", "android", "ipad", "iphone", "linux", "other"], p = "other|ie|chrome|firefox|webkit|safari|mobile_safari|mobile_webkit|ucbrowser|Gecko|opera|opera mini|opera mobi", l = "360|maxthon|qihu theworld|theworld|qqbrowser|taobrowser|se [0-9]+.|tencenttraveler|lbbrowser", b = new RegExp(l, "i"), m = ["ucbrowser", "crios", "mqqbrowser", "sogoumobilebrowser", "oupeng", "chrome"], w = "other", _ = "other", x = "00";
            if (f.indexOf("Android") > -1 ? c = "Android" : (c = f.match(/(Windows|Mac|Android|ipad|iphone|linux)/i), c = c ? c[0] : "other"), (s = f.match(/MSIE ([^;]*)|Trident.*; rv(?:\\s|:)?([\d.]+)/)) && s[1] ? (_ = "ie", _ = "trident", x = e(s[1])) : (s = f.match(/Chrome\/([\d.]*)/)) && s[1] && (_ = "chrome", w = "chrome", x = s[1]), (s = f.match(b)) && s[0] && f.indexOf("Android") < 0 && f.indexOf("Mobile") < 0) {
                if (f.indexOf("AppleWebKit") > -1 && (_ = "webkit"), w = s[0].toLocaleLowerCase(), (d = w.match(/se\s(\d+)\./i)) && d[1])
                    w = "se [0-9]+.", x = d[1];
            ...
            if ((s = f.match(/Trident.*; rv(?:\\s|:)?([0-9.]+)/)) && s[1])
                return w = "ie", _ = "trident", x = e(s[1]), h();
            ...
            if (f.indexOf("AppleWebKit") > -1)
                if (w = "webkit", _ = "webkit", (s = f.match(/OPR\/([\d.]*)/)) && s[1])
                    x = e(s[1]), w = "opera";
                    ...
                    (s = f.match(/\/([\d.]*) Safari/)) && s[1] ? (w = "safari", x = e(s[1]), !/version\/([\d.]+).*safari/.test(f) && (s = f.match(/Chrome\/([0-9.]*)/)) && s[1] && (w = "chrome", x = s[1])) : (s = f.match(/Chrome\/([0-9.]*)/)) && s[1] && (w = "chrome", x = s[1]);
            else
                (s = f.match(/Gecko/)) ? (w = "Gecko", _ = "Gecko", (s = f.match(/Firefox\/([\d.]*)/)) && s[1] && (w = "firefox", x = e(s[1]))) : (s = f.match(/Presto\/([\d.]*)/)) && s[1] && (_ = "presto", x = e(s[1]), (s = f.match(/Opera\/([\d.]*)/)) && s[1] && (w = "opera", x = e(s[1]), (s = f.match(/Opera\/.* Version\/([\d.]*)/)) && s[1] && (x = e(s[1])), (s = f.match(/Opera Mini[^;]*/)) && s ? (w = "opera mini", x = s[0]) : (s = f.match(/Opera Mobi[^;]*/)) && s && (w = "opera mobi", x = s[0])));
            return h()
        }
    }(), n = new r;
...
!function(t, n) {
    ...
    function r(t, n, r) {
        if (t) {
            ...
            if (e) {
                var o = r(e);
                return v || (o._str = e + ""), o._raw = e, t[n] = o, !0
            }
        }
    }
    function e(t, n, r) {
        v ? t.addEventListener(n, r) : t.attachEvent("on" + n, r)
    }
    function o(t) {
        if (t) {
            var n = t.match(h);
            if (n)
                return n = n[1], l.test(n) && (n = n.split("@").pop().split(":")[0]), n
        }
    }
    function i(t) {
        if (/^(\d+\.){3}\d+$/.test(t))
            return t;
        var n = p.test(t) ? -3 : -2, r = t.split(".");
    ...
    function c() {
        ...
        function c(t, n) {
            ...
            if (r(t))
                return h(), t;
            var e = b();
            return t + (/\?/.test(t) ? "&" : "?") + s + "=" + encodeURIComponent(e)
        }
        function h(t) {
            var r = b(t);
            n.cookie = E.replace("?", r)
        }
        function l() {
            e(n, "click", function(t) {
                t = t || event;
                var n = t.target || t.src;
                do
                    if ("A" == n.tagName) {
                        h();
                        break
        ...
        function d() {
            function t(t) {
                if (t && "SCRIPT" == t.tagName && /callback=/.test(t.src)) {
                    var n = c(t.src);
                    n && (t.src = n)
                }
            }
            if (v)
                r(Element.prototype, "insertBefore", function(n) {
                    return function(r) {
                        try {
                            t(r)
                        } catch (e) {
                ...
                r(o, "insertBefore", e), r(n.body, "insertBefore", e)
            }
        }
        var y = location.hostname, w = i(y), A = new RegExp("\\.?" + w.replace(/\./g, "\\.") + "$", "i");
        y != w && (n.cookie = f + "=1; domain=" + y + "; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT");
        var E = f + "=?; domain=" + w + "; path=/; expires=Fri, 01 Feb 2030 00:00:00 GMT";
        h(), setInterval(function() {
            h(!0)
        }, 2e3), l(), p(), d()
    }
    var f = "l", s = "isg2", v = !!t.addEventListener;
    r(Function.prototype, "toString", function(t) {
        return function() {
            return v ? t.apply(this._raw || this, arguments) : this._str || t.apply(this, arguments)
        }
    });
    var h = /^\s*(?:https?:)?\/{2,}([^\/\?\#\\]+)/i, l = /[@:]/, p = /\.com\.cn$|\.com\.hk$/, g = 1e10 * Math.random() >>> 0, m = Date.now || function() {
        return +new Date
    }, d = function(t) {
        ...
        return function(t) {
            for (var n = 0, e = t.length, o = []; e > n; ) {
                var i = t[n++] << 16 | t[n++] << 8 | t[n++];
                o.push(r.charAt(i >> 18), r.charAt(i >> 12 & 63), r.charAt(i >> 6 & 63), r.charAt(63 & i))
            }
            var u = e % 3;
            if (u) {
                var a = o.length - 1;
    ...
    a.prototype.toBuffer = function() {
        for (var t = [], n = -1, r = this._fields, e = 0, o = r.length; o > e; e++)
            for (var i = this[e], u = r[e], a = n += u; t[a] = 255 & i, 0 != --u; )
                --a, i >>= 8;
        return t
    };
    var w = function() {
        ...
        var o = 0, i = 0;
        return e(n, "touchmove", t), e(n, "mousemove", t), e(n, "mousewheel", r), function() {
            var t = {move: o,wheel: i};
            return o = i = 0, t
        }
    }(), b = function() {
        function n(t) {
            ...
            for (var r = 0, e = t.length; e > r; r++)
                C[r + 2] = t[r] ^ n, n = 31 * n & 255;
            return C
        }
        function r() {
            var n = "";
            try {
                n = t.ActiveXObject ? new ActiveXObject("ShockwaveFlash.ShockwaveFlash").GetVariable("$version").replace(",", ".") : navigator.plugins["Shockwave Flash"].description
            } catch (r) {
            }
        ...
        function o() {
            ...
            return t.replace("; SLCC2", "").replace(/; \.NET CLR [\d\.]+/, "")
        }
        function i() {
            return "object" == typeof chrome
        }
        function c() {
        ...
        function s() {
            return "object" == typeof safari
        }
        function v() {
            return "string" == typeof navigator.sgAppName
        }
        function h() {
        ...
        function j(t) {
            if (O[T] = u(), O[X] = m() / 1e3 | 0, O[F] = 0, !t) {
                var r = w();
                O[R] = r.move, O[_] = r.wheel
            }
            var e = O.toBuffer();
            return n(e)
        }
        var k = 1, C = [k], S = r(), L = [i, c, f, s, v, A, A, h, A, A, A, A, l, p, g, b], T = 0, M = 1, X = 2, B = 3, F = 4, N = 5, R = 6, _ = 7, O = new a([4, 4, 4, 2, 2, 2, 2, 2]);
        return O[B] = 65535 & d(o()), O[M] = e(), O[N] = E(), function(t) {
            var n = j(t), r = y(n);
            return r = r.replace(/\+/g, "-").replace(/\=/g, "_")
        }
    }();
    c()
}(window, document);
