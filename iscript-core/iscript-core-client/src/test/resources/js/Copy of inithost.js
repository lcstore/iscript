 ...
 * @returns {Window}
 */
Window.prototype.open = function(optionalArg1, optionalArg2, optionalArg3,
		optionalArg4) {
	return new Window();
};
/**
 ...
 * @memberOf Location
 */
Location.prototype.search = "search";
/**
 * function assign(arg)
 * 
 * @param {String}
 ...
 * @memberOf Navigator
 */
Navigator.prototype.appName = "lezo";
/**
 * Property appVersion
 * 
 * @type String
...
Navigator.prototype.userAgent = "Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.1; WOW64; Trident/4.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; .NET4.0C; .NET4.0E)";
/**
 ...
 * (e.g. obj[1]). Dereferencing with an integer index is equivalent to invoking
 * the item method with that index
 * 
 * @param {Number}
 *            index
 * @returns {Node}
...
/**
 * function item(index) Note: This object can also be dereferenced using square
...
/**
 * Property id http://www.w3.org/TR/2003/REC-DOM-Level-2-HTML-20030109/html.html
 * 
 * @type String
 * @since Standard ECMA-262 3rd. Edition
 * @since Level 2 Document Object Model HTML Specification.
...
/**
 * Property ch http://www.w3.org/TR/2003/REC-DOM-Level-2-HTML-20030109/html.html
 * 
 * @type String
 * @since Standard ECMA-262 3rd. Edition
 * @since Level 2 Document Object Model HTML Specification.
