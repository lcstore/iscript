...
public class ConfigProxyChecher implements ConfigParser {
	private static Logger logger = LoggerFactory.getLogger(ConfigProxyChecher.class);
	private DefaultHttpClient client;
	private static final String EMTPY_RESULT = new JSONObject().toString();
	private List<String> detectUrls;

	public ConfigProxyChecher() {
		detectUrls = new ArrayList<String>();
		detectUrls.add("http://www.ip138.com/");
		detectUrls.add("http://ip.chinaz.com/");
