	...
	public void testApiCall() throws Exception {
		...
		while (index < max) {
			try {
				...
				apiUrl = "http://open.taobao.com/apitools/apiTools.htm";
				apiUrl = "http://open.taobao.com/apitools/getResult.do";
				HttpPost post = new HttpPost(apiUrl);
				post.addHeader("Referer",
						"http://open.taobao.com/apitools/apiTools.htm?catId=4&apiId=28&apiName=taobao.item.sku.get&scopeId=");
