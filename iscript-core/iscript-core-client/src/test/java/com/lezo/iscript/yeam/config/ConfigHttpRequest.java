...
public class ConfigHttpRequest implements ConfigParser {
	private static Logger logger = LoggerFactory.getLogger(ConfigHttpRequest.class);
	private DefaultHttpClient client = HttpClientManager.getDefaultHttpClient();

	public ConfigHttpRequest() {
	}
	...
	private String convert2TaskCallBack(DataBean dataBean, TaskWritable task) throws Exception {
		...
		// JSONUtils.put(returnObject, ClientConstant.KEY_STORAGE_RESULT,
		// dataString);
