...
ALTER TABLE T_PROXY_ADDR
ADD COLUMN `MAP_TYPE` tinyint(4) NOT NULL default '0' COMMENT '地图类型',
ADD COLUMN `MAP_LAT` varchar(20) NOT NULL default '' COMMENT '纬度',
ADD COLUMN `MAP_LNG` varchar(20) NOT NULL default '' COMMENT '经度',
ADD COLUMN `AVG_COST`  int DEFAULT '0' COMMENT '平均耗时',
ADD COLUMN `FAIL_COUNT` int(11) NOT NULL default '0' COMMENT '失败数',
ADD COLUMN `SUCCESS_COUNT` int(11) NOT NULL default '0' COMMENT '成功数',
ADD COLUMN `LAST_SUCCESS_COUNT` int(11) NOT NULL default '0' COMMENT '连续成功数';

ALTER TABLE T_PROXY_ADDR
ADD COLUMN `REGION_COUNTRY` varchar(50) NOT NULL default '' COMMENT '国家',
ADD COLUMN `REGION_CITY` varchar(50) NOT NULL default '' COMMENT '城市';
