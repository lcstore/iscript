DROP TABLES IF EXISTS T_TASK_CONFIG;
CREATE TABLE `T_TASK_CONFIG` (
  ...
  `UPDATE_TIME` timestamp NOT NULL DEFAULT '1970-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

DROP TABLES IF EXISTS T_TASK_PRIORITY;
...
DROP TABLES IF EXISTS T_TYPE_CONFIG;
