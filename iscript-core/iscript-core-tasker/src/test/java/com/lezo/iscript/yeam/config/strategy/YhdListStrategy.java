...
public class YhdListStrategy implements ResultStrategy, Closeable {
	private TaskPriorityService taskPriorityService = SpringBeanUtils.getBean(TaskPriorityService.class);
	private static Logger logger = LoggerFactory.getLogger(YhdListStrategy.class);
	...
	private class CreateTaskTimer extends TimerTask {
		...
		public CreateTaskTimer() {
			...
			urlSet.add("http://list.yhd.com/c23586-0-81436/b/a-s2-v0-p1-price-d0-f0-m1-rt0-pid-mid0-k/");
			typeMap.put("ConfigYhdList", urlSet);
		}
