				...
				<c:forEach items="${configList}" var="configDto" varStatus="status">
					<tr>
						...
						<td><a href="javascript:void(0)"
							onclick="editConfig(this,'${configDto.type}')"><img
								src="${contextPath}/resources/images/user_edit.png" alt="更新"
								title="更新" border="0"></a></td>
						<td><a href="javascript:void(0)"
							onclick="deleteConfig(this,'${configDto.type}')"
							class="ask"><img
				...
				<form action="${contextPath}/configmgr/addConfig.action"
					...
					<fieldset>
						<div class="control-group">
							...
							<div class="controls">
								<input placeholder="配置名称，如tmall-product" class="popinput"
									type="text" name="configType">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input class="popinput" name="configFile" type="file"
									accept="text/xml,application/xml" width="80%">
							</div>
						</div>
						<div class="controls">
