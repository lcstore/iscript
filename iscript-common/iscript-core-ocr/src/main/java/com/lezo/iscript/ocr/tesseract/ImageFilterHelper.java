...
public  class ImageFilterHelper {
	...
	/** 图像二值化 */
	public static BufferedImage changeGrey(BufferedImage image) {
	...
	/** 平滑缩放 
	 * @param image */
	public static BufferedImage scaling(double s, BufferedImage image) {
	...
	public static BufferedImage scale(Float s, BufferedImage image) {
