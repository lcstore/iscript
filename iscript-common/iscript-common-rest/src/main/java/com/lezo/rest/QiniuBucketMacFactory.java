...
//		qiniuBacketMacMap.put(newBucketMac.getBucket(), newBucketMac);
		...
		qiniuBacketMacMap.put(newBucketMac.getBucket(), newBucketMac);
		newBucketMac = new QiniuBucketMac(new Mac("o3UQWUGKjGlObA0b4Du0mvmihKNvw9W4CohNgQcO", "cFWwkPfCqj1Bd4qpVnujJ2ecmU_5XqpCh0udaYxZ"), "v1000", 1);
		qiniuBacketMacMap.put(newBucketMac.getBucket(), newBucketMac);
		...
		qiniuBacketMacMap.put(newBucketMac.getBucket(), newBucketMac);
		newBucketMac = new QiniuBucketMac(new Mac("K5LxD4jMxDFgtBPA0KZAIIujt5yef1tvDDShqLcF", "oIdK7n4_FXDfSjroYL-JOu-3WFm-D0OjpHIvMp2z"), "p1002", 1);
		qiniuBacketMacMap.put(newBucketMac.getBucket(), newBucketMac);
		newBucketMac = new QiniuBucketMac(new Mac("NQ6jBmqGpWWtQd4a50m4p3nRN7VgBqLwPuTBQwjt", "khu7d6vZyqciM-HI6OYDvokdipn562Kd9SycW4QH"), "d1003", 1);
		qiniuBacketMacMap.put(newBucketMac.getBucket(), newBucketMac);
